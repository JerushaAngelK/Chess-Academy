...
import { Modal, Box, Typography, Button, TextField, Select, MenuItem, InputLabel, FormControl, FormControlLabel, Checkbox, IconButton, DialogActions } from '@mui/material';
...
const AdminEditProfileModal = ({ open, handleClose }) => {
